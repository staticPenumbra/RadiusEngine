...
var AIController = /** @class */ (function () {
    function AIController() {
        ...
        */
        this.DetectAvailableTarget = function (Viewer, Viewee) {
        ...
        var CurrentEntityPosition;
        var Entities; //Entity[]
        var PlayerEntities; //Entity[]
    }
    Object.defineProperty(AIController.prototype, "UpdateEntities", {
        //--------------------------------------------SET ACCESSORS--------------------------
        /**
        * @param {Entity[]} EntityList The list of entities to update
        */
        set: function (EntityList) {
            if (EntityList != null) {
    ...
    Object.defineProperty(AIController.prototype, "SetCurrentEntity", {
        /**
    ...
    Object.defineProperty(AIController.prototype, "GetCurrentEntity", {
        //--------------------------------------------GET ACCESSORS--------------------------
        /**
